...
export default function MedicalItineraryPage() {
  ...
  const steps = [
    ...
    { number: 4, title: 'Medical Itinerary', active: true, href: '/dashboard/medical-itinerary' },
    { number: 5, title: 'Accommodation & Visa', href: '/dashboard/accommodation' },
    { number: 6, title: 'Travel Preparation', href: '/dashboard/travel-prep' },
    { number: 7, title: 'Treatment & Recovery', href: '/dashboard/treatment-recovery' },
  ];
