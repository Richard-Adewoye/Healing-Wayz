...
export default function TravelPreparationPage() {
  const steps = [
    ...
    { number: 4, title: "Medical Itinerary", completed: true },
    { number: 5, title: "Accommodation & Visa", completed: true },
    { number: 6, title: "Travel Preparation", active: true },
    { number: 7, title: "Treatment & Recovery", completed: false },
  ];
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col justify-between hidden md:flex min-h-screen sticky top-0">
        <div>
          ...
          <nav className="px-4 py-6 space-y-1">
            <a
              href="#"
              className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg text-xs font-semibold bg-blue-50 text-[#1a237e] border-l-4 border-[#1a237e]"
            >
